...
export class Card {
  ...
  createCard() {
    this.#cardElementTemplate =
      this.constructor.cardElementTemplate.cloneNode(true);
    const cardData = this.#cardData;
    this.#handleLike();
    this.#handleDelete();
    this.#handleOpenImage(cardData);
    this.#cardElementTemplate.querySelector(".elements__image").src =
      this.#cardData.link;
    this.#cardElementTemplate.querySelector(".elements__image").alt =
      this.#cardData.name;
